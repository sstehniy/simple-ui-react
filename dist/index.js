...
function useCombinedRef(...refs) {
    return require$$0.useCallback((node) => {
...
const getRealBackgroundColor = (elem) => {
...
const Wrapper = styled__default['default'].div `
	...
	${({ showAnimatedName, realBackgroundColor, readonly }) => showAnimatedName &&
    !readonly &&
    styled.css `
			&::before {
...
`;
const TextInputComponent = ({ name, showAnimatedName = true, icon, iconPosition = "right", ...inputProps }, ref) => {
    const [classNames, setClassNames] = require$$0.useState([]);
    const [realBackgroundColor, setRealBackgroundColor] = require$$0.useState();
    const inputRef = require$$0.useRef(null);
    const wrapperRef = require$$0.useRef(null);
    ...
    require$$0.useEffect(() => {
        if (!inputRef.current || !showAnimatedName)
            return;
        const setClassNamesOnBlur = (e) => {
            const classNames = [];
    ...
    return (jsxRuntime.exports.jsxs(Wrapper, Object.assign({ "data-name": name, showAnimatedName: showAnimatedName, iconPosition: iconPosition, ref: wrapperRef, realBackgroundColor: realBackgroundColor || "transparent", readonly: inputProps.readOnly, className: clsx(...classNames) }, { children: [jsxRuntime.exports.jsx(StyledInput, Object.assign({ ref: combinedRef }, inputProps), void 0),
            icon && jsxRuntime.exports.jsx(StyledIconWrapper, { children: icon }, void 0)] }), void 0));
};
const TextInput = require$$0.forwardRef(TextInputComponent);

const HelloWorldWrapper = styled__default['default'].div ``;
const HelloWorld = ({ children }) => {
    return jsxRuntime.exports.jsx(HelloWorldWrapper, { children: children }, void 0);
};
