import require$$0, { useCallback, forwardRef, useState, useRef, useEffect } from 'react';
...
const TextInputComponent = ({ name, showAnimatedName = true, icon, iconPosition = "right", ...inputProps }, ref) => {
    ...
    const [realBackgroundColor, setRealBackgroundColor] = useState();
